# Factorial Seeker class implementation.
# This class implements the Job Seeker child for Factorial platform
...
class FactorialSeeker(JobSeeker):
    ...
    def get_job_description(self) -> str:
        ...
        element = self.browser.find_element(By.CLASS_NAME, "styledText")
